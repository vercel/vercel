...
The Vercel CLI is already installed globally and authenticated via the VERCEL_TOKEN environment variable. The project is already linked via `.vercel/project.json`.
