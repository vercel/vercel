export const getDefaultConfig = async existingCopy => {
  ...
  const config = {
    _:
      'This is your Now config file. For more information see the global configuration documentation: https://vercel.com/docs/v2/advanced/global-configuration',
    collectMetrics: true
  };
...
export const getDefaultAuthConfig = async existing => {
  ...
  const config = {
    _:
      'This is your Now credentials file. DO NOT SHARE! More: https://vercel.com/docs/v2/advanced/global-configuration'
  };
