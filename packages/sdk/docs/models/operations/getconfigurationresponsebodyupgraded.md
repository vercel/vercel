...
```typescript
import { GetConfigurationResponseBodyUpgraded } from "@vercel/sdk/models/operations/getconfiguration.js";

let value: GetConfigurationResponseBodyUpgraded = "read-write:deployment-check";
```
