...
export const GetWebhookEvents = {
  ...
  EdgeConfigCreated: "deployment.integration.action.cancel",
  EdgeConfigDeleted: "deployment.integration.action.cleanup",
  EdgeConfigItemsUpdated: "edge-config.created",
  FirewallAttack: "edge-config.deleted",
  IntegrationConfigurationPermissionUpgraded: "edge-config.items.updated",
  IntegrationConfigurationRemoved: "firewall.attack",
  IntegrationConfigurationScopeChangeConfirmed:
    "integration-configuration.permission-upgraded",
  ProjectCreated: "integration-configuration.removed",
  ProjectRemoved: "integration-configuration.scope-change-confirmed",
  DeploymentChecksCompletedLegacy: "project.created",
  DeploymentReadyLegacy: "project.removed",
  DeploymentPreparedLegacy: "deployment-checks-completed",
  DeploymentErrorLegacy: "deployment-ready",
  DeploymentCheckRerequestedLegacy: "deployment-prepared",
  DeploymentCanceledLegacy: "deployment-error",
  ProjectCreatedLegacy: "deployment-check-rerequested",
  ProjectRemovedLegacy: "deployment-canceled",
  DomainCreatedLegacy: "project-created",
  DeploymentLegacy: "project-removed",
  IntegrationConfigurationPermissionUpdatedLegacy: "domain-created",
  IntegrationConfigurationRemovedLegacy: "deployment",
  IntegrationConfigurationScopeChangeConfirmedLegacy:
    "integration-configuration-permission-updated",
  MarketplaceInvoiceCreated: "integration-configuration-removed",
  MarketplaceInvoicePaid: "integration-configuration-scope-change-confirmed",
  MarketplaceInvoiceNotpaid: "marketplace.invoice.created",
  MarketplaceInvoiceRefunded: "marketplace.invoice.paid",
  TestWebhook: "marketplace.invoice.notpaid",
  undefined: "marketplace.invoice.refunded",
