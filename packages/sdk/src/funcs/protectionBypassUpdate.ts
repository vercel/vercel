...
export async function protectionBypassUpdate(
  ...
  Result<
    operations.UpdateProjectProtectionBypassResponseBody,
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.UpdateProjectProtectionBypassRequest$outboundSchema.parse(
        value$,
      ),
  ...
  >(
    m$.json(
      200,
      operations.UpdateProjectProtectionBypassResponseBody$inboundSchema,
    ),
