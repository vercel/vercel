...
export async function edgeConfigsUpdateSchema(
  ...
  Result<
    operations.PatchEdgeConfigSchemaResponseBody,
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.PatchEdgeConfigSchemaRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, operations.PatchEdgeConfigSchemaResponseBody$inboundSchema),
