...
export async function accessGroupsListMembers(
  ...
  Result<
    operations.ListAccessGroupMembersResponseBody,
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const parsed$ = schemas$.safeParse(
    input$,
    (value$) =>
      operations.ListAccessGroupMembersRequest$outboundSchema.parse(value$),
  ...
  const [result$] = await m$.match<
    ...
    | ConnectionError
  >(
    m$.json(200, operations.ListAccessGroupMembersResponseBody$inboundSchema),
