...
Defined in: [packages/oidc/src/get-vercel-oidc-token-with-refresh.ts:64](https://github.com/vercel/vercel-cli-fluid-runtimes/blob/main/packages/oidc/src/get-vercel-oidc-token-with-refresh.ts#L64)
