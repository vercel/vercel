...
Defined in: [packages/oidc/src/get-vercel-oidc-token-with-refresh.ts:66](https://github.com/vercel/vercel/blob/main/packages/oidc/src/get-vercel-oidc-token-with-refresh.ts#L66)
