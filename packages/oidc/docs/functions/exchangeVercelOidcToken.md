...
Defined in: [packages/oidc/src/exchange-vercel-oidc-token.ts:73](https://github.com/vercel/vercel/blob/main/packages/oidc/src/exchange-vercel-oidc-token.ts#L73)
