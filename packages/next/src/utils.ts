...
export async function getPageLambdaGroups({
  ...
  for (const page of pages) {
    ...
    const isGeneratedSteps = routeName.includes(
      'api/.well-known/generated/steps'
    );
    const isGeneratedWorkflows = routeName.includes(
      'api/.well-known/generated/workflows'
    );
