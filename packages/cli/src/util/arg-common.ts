...
/**
 * Collects only global CLI flags from argv so suggested `next` commands
 * preserve context (--cwd, --non-interactive, etc.) without forwarding
 * subcommand-specific flags that would parse-error on another subcommand.
 */
