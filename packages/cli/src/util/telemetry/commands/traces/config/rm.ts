...
import type { rmSubcommand } from '../../../../../commands/traces/config/command';

export class TracesConfigRmTelemetryClient
  ...
  implements TelemetryMethods<typeof rmSubcommand>
{
  ...
  trackCliFlagDefault(defaultOnly: boolean | undefined) {
    if (defaultOnly) {
