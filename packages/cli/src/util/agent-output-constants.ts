 ...
 * across commands (redirects, routes, dns, env, flags, etc.) and can be documented as a single source of truth.
 */
...
export const AGENT_REASON = {
  ...
  /** No credentials found; user must run login or pass --token */
