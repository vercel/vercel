...
import { TOOL_SPAN_PREFIX, type OnboardProfile } from './profile';
...
export class StreamRenderer {
  ...
  private readonly profile: OnboardProfile | undefined;
  ...
  constructor(activity?: ActivityIndicator, profile?: OnboardProfile) {
