...
export const buySubcommand = {
  ...
  options: [
    {
      ...
      argument: 'NUMBER',
      description:
        'Registration term in years (must match the quoted term for the domain)',
      deprecated: false,
    },
    {
      name: 'auto-renew',
      shorthand: null,
      type: Boolean,
      description: 'Renew the domain automatically at the end of the term',
      deprecated: false,
    },
    {
      name: 'no-auto-renew',
      shorthand: null,
      type: Boolean,
      description: 'Do not renew the domain automatically',
      deprecated: false,
    },
    {
      name: 'expected-price',
      ...
      argument: 'USD',
      description:
        'Refuse to purchase when the quoted purchase price differs from this amount',
      deprecated: false,
    },
    {
      name: 'first-name',
    ...
    },
    {
      ...
      argument: 'PHONE',
      description:
        'Registrant phone number with country code (e.g. +15551234567)',
      deprecated: false,
    },
    {
      name: 'address',
    ...
    },
    {
      ...
      type: String,
      argument: 'CC',
      description: 'Registrant two-letter country code (e.g. US)',
      deprecated: false,
    },
    {
      name: 'company',
      ...
      type: String,
      argument: 'NAME',
      description: 'Registrant company name (optional)',
      deprecated: false,
    },
    formatOption,
  ],
  examples: [
    {
      name: 'Buy a domain interactively',
      value: `${packageName} domains buy example.com`,
    },
    {
      name: 'Prefill purchase details so only missing ones are prompted',
      value: `${packageName} domains buy example.com --years 1 --auto-renew --first-name Jane --last-name Doe --email jane@example.com --country US`,
    },
    {
      name: 'Agent-friendly dry run: checks availability and price, then returns the prefilled interactive command (never purchases; exit code 0 when the domain is buyable)',
      value: `${packageName} domains buy example.com --non-interactive`,
    },
    {
      name: 'JSON output with the same prepare-only behavior',
      value: `${packageName} domains buy example.com --format json`,
    },
  ],
} as const;
