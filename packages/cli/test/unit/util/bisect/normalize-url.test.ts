...
describe('normalize-url', () => {
  it.skip('should add https to url without scheme', () => {
    const normalizedUrl = normalizeURL('vercel.com');
    expect(normalizedUrl).toEqual('https://vercel.com');
  });
  it.skip('should not add anything to a url that starts with https', () => {
    const normalizedUrl = normalizeURL('https://vercel.com');
    expect(normalizedUrl).toEqual('https://vercel.com');
  });
  it.skip('should not add anything to a url that starts with http', () => {
