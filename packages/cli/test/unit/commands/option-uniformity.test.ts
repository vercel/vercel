...
import { changelogCommand } from '../../../src/commands/changelog/command';
...
const OUTPUT_FLAG_EXCEPTIONS = {
  ...
  'firewall alerts inspect':
    'Firewall preserves its established --json contract',
  'firewall alerts list': 'Firewall preserves its established --json contract',
  ...
  'firewall persistent-actions inspect':
    'Firewall preserves its established --json contract',
  ...
  'firewall status': 'Firewall preserves its established --json contract',
  ...
  'flags stale': 'Flags preserves its established --json contract',
...
const PROMPT_WITHOUT_YES_EXCEPTIONS = {
  ...
  'project pause':
    'Pausing production traffic requires interactive typed confirmation',
  'project remove': 'Severe deletion needs typed or command-specific proof',
  'project resume':
    'Resuming production traffic requires interactive confirmation',
