...
describe('whoami', () => {
  it.skip('should reject invalid arguments', async () => {
  ...
  it.skip('should print the Vercel username', async () => {
    const user = useUser();
  ...
  it.skip('should print only the Vercel username when output is not a TTY', async () => {
    const user = useUser();
