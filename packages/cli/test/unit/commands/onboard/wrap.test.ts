...
import {
  ...
  visibleWidth,
  wrapAnsi,
} from '../../../../src/commands/onboard/wrap';
...
describe('onboard wrapAnsi with wide characters', () => {
...
describe('onboard truncateAnsi with wide characters', () => {
