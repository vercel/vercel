...
const ALL_EVALS: string[] = [
  ...
  'logs/explicit',
  'logs/implicit',
  'marketplace/categories-discoverability',
  'marketplace/discover-by-category',
  'marketplace/discover-vague-intent',
  ...
  'non-interactive',
  'project/inspect/explicit',
  'project/inspect/implicit',
  'project/list/explicit',
  'project/list/implicit',
  'pull',
];
