...
Defined in: [packages/functions/src/cache/index.ts:33](https://github.com/vercel/vercel-cli-fluid-runtimes/blob/main/packages/functions/src/cache/index.ts#L33)
