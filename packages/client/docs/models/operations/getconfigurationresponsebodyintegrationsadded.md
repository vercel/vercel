...
```typescript
import { GetConfigurationResponseBodyIntegrationsAdded } from '@vercel/client/models/operations';

let value: GetConfigurationResponseBodyIntegrationsAdded = 'read:team';
```
