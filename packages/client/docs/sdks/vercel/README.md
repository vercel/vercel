...
import { listDeploymentBuilds } from '@vercel/client/funcs/listDeploymentBuilds.js';
...
async function run() {
  const res = await listDeploymentBuilds(vercel, {
    deploymentId: '<value>',
  });
...
| ---------------------- | ------------------------------------------------------------------------------------------------ | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`              | [operations.ListDeploymentBuildsRequest](../../models/operations/listdeploymentbuildsrequest.md) | :heavy_check_mark: | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[operations.ListDeploymentBuildsResponseBody](../../models/operations/listdeploymentbuildsresponsebody.md)\>**
...
```typescript
import { VercelCore } from '@vercel/client/core.js';
import { datacachePurgeall } from '@vercel/client/funcs/datacachePurgeall.js';
...
```typescript
import { VercelCore } from '@vercel/client/core.js';
import { dataCacheBillingSettings } from '@vercel/client/funcs/dataCacheBillingSettings.js';
