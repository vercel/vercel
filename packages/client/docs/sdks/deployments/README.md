...
import { deploymentsGetEvents } from "@vercel/client/funcs/deploymentsGetEvents.js";
...
```typescript
import { VercelCore } from '@vercel/client/core.js';
import { deploymentsGet } from '@vercel/client/funcs/deploymentsGet.js';
...
**Promise\<[operations.GetDeploymentResponseBody](../../models/operations/getdeploymentresponsebody.md)\>**
...
```typescript
import { VercelCore } from '@vercel/client/core.js';
import { deploymentsCreate } from '@vercel/client/funcs/deploymentsCreate.js';
...
**Promise\<[operations.CreateDeploymentResponseBody](../../models/operations/createdeploymentresponsebody.md)\>**
...
```typescript
import { VercelCore } from '@vercel/client/core.js';
import { deploymentsCancel } from '@vercel/client/funcs/deploymentsCancel.js';
...
| Parameter              | Type                                                                                     | Required           | Description                                                                                                                                                                    |
| ---------------------- | ---------------------------------------------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`              | [operations.CancelDeploymentRequest](../../models/operations/canceldeploymentrequest.md) | :heavy_check_mark: | The request object to use for the request.                                                                                                                                     |
| `options`              | RequestOptions                                                                           | :heavy_minus_sign: | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions` | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)  | :heavy_minus_sign: | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`      | [RetryConfig](../../lib/utils/retryconfig.md)                                            | :heavy_minus_sign: | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.CancelDeploymentResponseBody](../../models/operations/canceldeploymentresponsebody.md)\>**
...
```typescript
import { VercelCore } from '@vercel/client/core.js';
import { deploymentsUploadFile } from '@vercel/client/funcs/deploymentsUploadFile.js';
...
**Promise\<[operations.UploadFileResponseBody](../../models/operations/uploadfileresponsebody.md)\>**
...
```typescript
import { VercelCore } from '@vercel/client/core.js';
import { deploymentsListAliases } from '@vercel/client/funcs/deploymentsListAliases.js';
...
```typescript
import { VercelCore } from '@vercel/client/core.js';
import { deploymentsListFiles } from '@vercel/client/funcs/deploymentsListFiles.js';
...
| Parameter              | Type                                                                                           | Required           | Description                                                                                                                                                                    |
| ---------------------- | ---------------------------------------------------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`              | [operations.ListDeploymentFilesRequest](../../models/operations/listdeploymentfilesrequest.md) | :heavy_check_mark: | The request object to use for the request.                                                                                                                                     |
| `options`              | RequestOptions                                                                                 | :heavy_minus_sign: | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions` | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)        | :heavy_minus_sign: | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`      | [RetryConfig](../../lib/utils/retryconfig.md)                                                  | :heavy_minus_sign: | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[components.FileTree[]](../../models/.md)\>**
...
```typescript
import { VercelCore } from '@vercel/client/core.js';
import { deploymentsGetFileContents } from '@vercel/client/funcs/deploymentsGetFileContents.js';
...
```typescript
import { VercelCore } from '@vercel/client/core.js';
import { deploymentsList } from '@vercel/client/funcs/deploymentsList.js';
...
```typescript
import { VercelCore } from '@vercel/client/core.js';
import { deploymentsDelete } from '@vercel/client/funcs/deploymentsDelete.js';
...
**Promise\<[operations.DeleteDeploymentResponseBody](../../models/operations/deletedeploymentresponsebody.md)\>**
