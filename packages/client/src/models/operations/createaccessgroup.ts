...
> = z.object({
  name: z.string(),
  projects: z
    .array(z.lazy(() => CreateAccessGroupProjects$inboundSchema))
    .optional(),
...
> = z.object({
  name: z.string(),
  projects: z
    .array(z.lazy(() => CreateAccessGroupProjects$outboundSchema))
    .optional(),
  membersToAdd: z.array(z.string()).optional(),
});
...
> = z
  .object({
    ...
    RequestBody: z
      .lazy(() => CreateAccessGroupRequestBody$inboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    ...
    slug: z.string().optional(),
    requestBody: z
      .lazy(() => CreateAccessGroupRequestBody$outboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
