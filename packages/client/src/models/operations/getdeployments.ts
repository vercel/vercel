...
> = z.object({
  ...
  speedInsights: z
    .lazy(() => GetDeploymentsSpeedInsights$inboundSchema)
    .optional(),
  webAnalytics: z
    .lazy(() => GetDeploymentsWebAnalytics$inboundSchema)
    .optional(),
...
> = z.object({
  ...
  createdAt: z.number().optional(),
  speedInsights: z
    .lazy(() => GetDeploymentsSpeedInsights$outboundSchema)
    .optional(),
  webAnalytics: z
    .lazy(() => GetDeploymentsWebAnalytics$outboundSchema)
    .optional(),
  skipGitConnectDuringLink: z.boolean().optional(),
  gitComments: z
    .lazy(() => GetDeploymentsGitComments$outboundSchema)
    .optional(),
});
...
> = z.object({
  ...
  projectSettings: z
    .lazy(() => GetDeploymentsProjectSettings$inboundSchema)
    .optional(),
  ...
  customEnvironment: z
    .lazy(() => GetDeploymentsCustomEnvironment$inboundSchema)
    .optional(),
});
...
> = z.object({
  ...
  isRollbackCandidate: z.nullable(z.boolean()).optional(),
  projectSettings: z
    .lazy(() => GetDeploymentsProjectSettings$outboundSchema)
    .optional(),
  connectBuildsEnabled: z.boolean().optional(),
  connectConfigurationId: z.string().optional(),
  passiveConnectConfigurationId: z.string().optional(),
  ...
  proposedExpiration: z.number().optional(),
  customEnvironment: z
    .lazy(() => GetDeploymentsCustomEnvironment$outboundSchema)
    .optional(),
});
