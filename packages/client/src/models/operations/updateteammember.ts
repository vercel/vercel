...
> = z.object({
  ...
  projects: z
    .array(z.lazy(() => UpdateTeamMemberProjects$inboundSchema))
    .optional(),
...
> = z.object({
  ...
  role: z.string().default('VIEWER'),
  projects: z
    .array(z.lazy(() => UpdateTeamMemberProjects$outboundSchema))
    .optional(),
  joinedFrom: z
    .lazy(() => UpdateTeamMemberJoinedFrom$outboundSchema)
    .optional(),
});
...
> = z
  .object({
    ...
    uid: z.string(),
    RequestBody: z
      .lazy(() => UpdateTeamMemberRequestBody$inboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    ...
    uid: z.string(),
    requestBody: z
      .lazy(() => UpdateTeamMemberRequestBody$outboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
