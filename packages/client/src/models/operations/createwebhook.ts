...
/** @internal */
export const Events$inboundSchema: z.ZodNativeEnum<typeof Events> =
  z.nativeEnum(Events);
...
> = z
  .object({
    ...
    RequestBody: z
      .lazy(() => CreateWebhookRequestBody$inboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    ...
    slug: z.string().optional(),
    requestBody: z
      .lazy(() => CreateWebhookRequestBody$outboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
