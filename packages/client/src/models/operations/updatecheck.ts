...
/** @internal */
export const Fcp$inboundSchema: z.ZodType<Fcp, z.ZodTypeDef, unknown> =
  z.object({
...
/** @internal */
export const Fcp$outboundSchema: z.ZodType<Fcp$Outbound, z.ZodTypeDef, Fcp> =
  z.object({
    value: z.nullable(z.number()),
    previousValue: z.number().optional(),
...
/** @internal */
export const Lcp$inboundSchema: z.ZodType<Lcp, z.ZodTypeDef, unknown> =
  z.object({
    value: z.nullable(z.number()),
    previousValue: z.number().optional(),
...
/** @internal */
export const Lcp$outboundSchema: z.ZodType<Lcp$Outbound, z.ZodTypeDef, Lcp> =
  z.object({
    value: z.nullable(z.number()),
    previousValue: z.number().optional(),
...
/** @internal */
export const Cls$inboundSchema: z.ZodType<Cls, z.ZodTypeDef, unknown> =
  z.object({
    value: z.nullable(z.number()),
    previousValue: z.number().optional(),
...
/** @internal */
export const Cls$outboundSchema: z.ZodType<Cls$Outbound, z.ZodTypeDef, Cls> =
  z.object({
    value: z.nullable(z.number()),
    previousValue: z.number().optional(),
...
/** @internal */
export const Tbt$inboundSchema: z.ZodType<Tbt, z.ZodTypeDef, unknown> =
  z.object({
    value: z.nullable(z.number()),
    previousValue: z.number().optional(),
...
/** @internal */
export const Tbt$outboundSchema: z.ZodType<Tbt$Outbound, z.ZodTypeDef, Tbt> =
  z.object({
    value: z.nullable(z.number()),
    previousValue: z.number().optional(),
  ...
  z
    .object({
      ...
      virtualExperienceScore: z
        .lazy(() => VirtualExperienceScore$inboundSchema)
        .optional(),
    })
    .transform(v => {
      return remap$(v, {
...
> = z
  .object({
    ...
    virtualExperienceScore: z
      .lazy(() => VirtualExperienceScore$outboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
