...
/** @internal */
export const Paths$inboundSchema: z.ZodType<Paths, z.ZodTypeDef, unknown> =
  z.object({
    value: z.string(),
  });
...
> = z.object({
  ...
  oidcTokenConfig: z
    .lazy(() => UpdateProjectOidcTokenConfig$inboundSchema)
    .optional(),
  passwordProtection: z
    .nullable(z.lazy(() => PasswordProtection$inboundSchema))
    .optional(),
  ssoProtection: z
    .nullable(z.lazy(() => SsoProtection$inboundSchema))
    .optional(),
  trustedIps: z.nullable(z.lazy(() => TrustedIps$inboundSchema)).optional(),
  optionsAllowlist: z
    .nullable(z.lazy(() => OptionsAllowlist$inboundSchema))
    .optional(),
});
...
> = z.object({
  ...
  enableAffectedProjectsDeployments: z.boolean().optional(),
  oidcTokenConfig: z
    .lazy(() => UpdateProjectOidcTokenConfig$outboundSchema)
    .optional(),
  passwordProtection: z
    .nullable(z.lazy(() => PasswordProtection$outboundSchema))
    .optional(),
  ssoProtection: z
    .nullable(z.lazy(() => SsoProtection$outboundSchema))
    .optional(),
  trustedIps: z.nullable(z.lazy(() => TrustedIps$outboundSchema)).optional(),
  optionsAllowlist: z
    .nullable(z.lazy(() => OptionsAllowlist$outboundSchema))
    .optional(),
});
...
> = z
  .object({
    ...
    RequestBody: z
      .lazy(() => UpdateProjectRequestBody$inboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    ...
    slug: z.string().optional(),
    requestBody: z
      .lazy(() => UpdateProjectRequestBody$outboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z.object({
  ...
  aliasError: z
    .nullable(z.lazy(() => UpdateProjectAliasError$inboundSchema))
    .optional(),
...
> = z.object({
  ...
  aliasAssigned: z.nullable(z.union([z.number(), z.boolean()])).optional(),
  aliasError: z
    .nullable(z.lazy(() => UpdateProjectProjectsAliasError$inboundSchema))
    .optional(),
  aliasFinal: z.nullable(z.string()).optional(),
  automaticAliases: z.array(z.string()).optional(),
  builds: z
    .array(z.lazy(() => UpdateProjectProjectsBuilds$inboundSchema))
    .optional(),
  connectBuildsEnabled: z.boolean().optional(),
  connectConfigurationId: z.string().optional(),
  createdAt: z.number(),
  ...
  withCache: z.boolean().optional(),
  checksConclusion:
    UpdateProjectProjectsChecksConclusion$inboundSchema.optional(),
...
> = z.object({
  ...
  aliasAssigned: z.nullable(z.union([z.number(), z.boolean()])).optional(),
  aliasError: z
    .nullable(z.lazy(() => UpdateProjectProjectsAliasError$outboundSchema))
    .optional(),
  aliasFinal: z.nullable(z.string()).optional(),
  automaticAliases: z.array(z.string()).optional(),
  builds: z
    .array(z.lazy(() => UpdateProjectProjectsBuilds$outboundSchema))
    .optional(),
  connectBuildsEnabled: z.boolean().optional(),
  connectConfigurationId: z.string().optional(),
  createdAt: z.number(),
  ...
  withCache: z.boolean().optional(),
  checksConclusion:
    UpdateProjectProjectsChecksConclusion$outboundSchema.optional(),
...
> = z.object({
  src: z
    .union([z.lazy(() => UpdateProjectSrc2$inboundSchema), z.string()])
    .optional(),
...
> = z.object({
  src: z
    .union([z.lazy(() => UpdateProjectSrc2$outboundSchema), z.string()])
    .optional(),
  has: z.array(z.lazy(() => UpdateProjectHas$outboundSchema)).optional(),
  missing: z
    .array(z.lazy(() => UpdateProjectMissing$outboundSchema))
    .optional(),
  dest: z.string().optional(),
  status: z.number().optional(),
...
> = z.object({
  ...
  speedInsights: z
    .lazy(() => UpdateProjectSpeedInsights$inboundSchema)
    .optional(),
  autoExposeSystemEnvs: z.boolean().optional(),
  autoAssignCustomDomains: z.boolean().optional(),
  autoAssignCustomDomainsUpdatedBy: z.string().optional(),
  ...
  framework: z
    .nullable(UpdateProjectProjectsFramework$inboundSchema)
    .optional(),
  gitForkProtection: z.boolean().optional(),
  gitLFS: z.boolean().optional(),
  id: z.string(),
  ...
  ssoProtection: z
    ...
    .optional(),
  targets: z
    .record(z.lazy(() => UpdateProjectTargets$inboundSchema))
    .optional(),
  ...
  webAnalytics: z
    .lazy(() => UpdateProjectWebAnalytics$inboundSchema)
    .optional(),
  security: z.lazy(() => UpdateProjectSecurity$inboundSchema).optional(),
  oidcTokenConfig: z
    .lazy(() => UpdateProjectProjectsOidcTokenConfig$inboundSchema)
    .optional(),
...
> = z.object({
  ...
  speedInsights: z
    .lazy(() => UpdateProjectSpeedInsights$outboundSchema)
    .optional(),
  autoExposeSystemEnvs: z.boolean().optional(),
  autoAssignCustomDomains: z.boolean().optional(),
  autoAssignCustomDomainsUpdatedBy: z.string().optional(),
  ...
  framework: z
    .nullable(UpdateProjectProjectsFramework$outboundSchema)
    .optional(),
  gitForkProtection: z.boolean().optional(),
  gitLFS: z.boolean().optional(),
  id: z.string(),
  ...
  ssoProtection: z
    ...
    .optional(),
  targets: z
    .record(z.lazy(() => UpdateProjectTargets$outboundSchema))
    .optional(),
  transferCompletedAt: z.number().optional(),
  transferStartedAt: z.number().optional(),
  transferToAccountId: z.string().optional(),
  ...
  concurrencyBucketName: z.string().optional(),
  webAnalytics: z
    .lazy(() => UpdateProjectWebAnalytics$outboundSchema)
    .optional(),
  security: z.lazy(() => UpdateProjectSecurity$outboundSchema).optional(),
  oidcTokenConfig: z
    .lazy(() => UpdateProjectProjectsOidcTokenConfig$outboundSchema)
    .optional(),
