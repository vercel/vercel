...
/** @internal */
export const Target2$inboundSchema: z.ZodNativeEnum<typeof Target2> =
  z.nativeEnum(Target2);
...
/** @internal */
export const Target1$inboundSchema: z.ZodNativeEnum<typeof Target1> =
  z.nativeEnum(Target1);
...
> = z
  .object({
    ...
    RequestBody: z
      .lazy(() => CreateProjectRequestBody$inboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    ...
    slug: z.string().optional(),
    requestBody: z
      .lazy(() => CreateProjectRequestBody$outboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z.object({
  ...
  aliasError: z
    .nullable(z.lazy(() => CreateProjectAliasError$inboundSchema))
    .optional(),
...
> = z.object({
  ...
  aliasAssigned: z.nullable(z.union([z.number(), z.boolean()])).optional(),
  aliasError: z
    .nullable(z.lazy(() => CreateProjectProjectsAliasError$inboundSchema))
    .optional(),
  aliasFinal: z.nullable(z.string()).optional(),
  automaticAliases: z.array(z.string()).optional(),
  builds: z
    .array(z.lazy(() => CreateProjectProjectsBuilds$inboundSchema))
    .optional(),
  connectBuildsEnabled: z.boolean().optional(),
  connectConfigurationId: z.string().optional(),
  createdAt: z.number(),
  ...
  withCache: z.boolean().optional(),
  checksConclusion:
    CreateProjectProjectsChecksConclusion$inboundSchema.optional(),
...
> = z.object({
  ...
  aliasAssigned: z.nullable(z.union([z.number(), z.boolean()])).optional(),
  aliasError: z
    .nullable(z.lazy(() => CreateProjectProjectsAliasError$outboundSchema))
    .optional(),
  aliasFinal: z.nullable(z.string()).optional(),
  automaticAliases: z.array(z.string()).optional(),
  builds: z
    .array(z.lazy(() => CreateProjectProjectsBuilds$outboundSchema))
    .optional(),
  connectBuildsEnabled: z.boolean().optional(),
  connectConfigurationId: z.string().optional(),
  createdAt: z.number(),
  ...
  withCache: z.boolean().optional(),
  checksConclusion:
    CreateProjectProjectsChecksConclusion$outboundSchema.optional(),
...
> = z.object({
  src: z
    .union([z.lazy(() => CreateProjectSrc2$inboundSchema), z.string()])
    .optional(),
...
> = z.object({
  src: z
    .union([z.lazy(() => CreateProjectSrc2$outboundSchema), z.string()])
    .optional(),
  has: z.array(z.lazy(() => CreateProjectHas$outboundSchema)).optional(),
  missing: z
    .array(z.lazy(() => CreateProjectMissing$outboundSchema))
    .optional(),
  dest: z.string().optional(),
  status: z.number().optional(),
...
> = z.object({
  ...
  speedInsights: z
    .lazy(() => CreateProjectSpeedInsights$inboundSchema)
    .optional(),
  ...
  framework: z
    .nullable(CreateProjectProjectsFramework$inboundSchema)
    .optional(),
  ...
  ssoProtection: z
    ...
    .optional(),
  targets: z
    .record(z.lazy(() => CreateProjectTargets$inboundSchema))
    .optional(),
  ...
  webAnalytics: z
    .lazy(() => CreateProjectWebAnalytics$inboundSchema)
    .optional(),
  security: z.lazy(() => CreateProjectSecurity$inboundSchema).optional(),
  oidcTokenConfig: z
    .lazy(() => CreateProjectOidcTokenConfig$inboundSchema)
    .optional(),
...
> = z.object({
  ...
  speedInsights: z
    .lazy(() => CreateProjectSpeedInsights$outboundSchema)
    .optional(),
  autoExposeSystemEnvs: z.boolean().optional(),
  autoAssignCustomDomains: z.boolean().optional(),
  autoAssignCustomDomainsUpdatedBy: z.string().optional(),
  ...
  framework: z
    .nullable(CreateProjectProjectsFramework$outboundSchema)
    .optional(),
  gitForkProtection: z.boolean().optional(),
  gitLFS: z.boolean().optional(),
  id: z.string(),
  ...
  ssoProtection: z
    ...
    .optional(),
  targets: z
    .record(z.lazy(() => CreateProjectTargets$outboundSchema))
    .optional(),
  transferCompletedAt: z.number().optional(),
  transferStartedAt: z.number().optional(),
  transferToAccountId: z.string().optional(),
  ...
  concurrencyBucketName: z.string().optional(),
  webAnalytics: z
    .lazy(() => CreateProjectWebAnalytics$outboundSchema)
    .optional(),
  security: z.lazy(() => CreateProjectSecurity$outboundSchema).optional(),
  oidcTokenConfig: z
    .lazy(() => CreateProjectOidcTokenConfig$outboundSchema)
    .optional(),
