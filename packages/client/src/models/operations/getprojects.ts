...
> = z.object({
  ...
  aliasError: z
    .nullable(z.lazy(() => GetProjectsAliasError$inboundSchema))
    .optional(),
...
> = z.object({
  ...
  aliasAssigned: z.nullable(z.union([z.number(), z.boolean()])).optional(),
  aliasError: z
    .nullable(z.lazy(() => GetProjectsAliasError$outboundSchema))
    .optional(),
  aliasFinal: z.nullable(z.string()).optional(),
  automaticAliases: z.array(z.string()).optional(),
...
> = z.object({
  ...
  aliasAssigned: z.nullable(z.union([z.number(), z.boolean()])).optional(),
  aliasError: z
    .nullable(z.lazy(() => GetProjectsProjectsAliasError$inboundSchema))
    .optional(),
  aliasFinal: z.nullable(z.string()).optional(),
  automaticAliases: z.array(z.string()).optional(),
  builds: z
    .array(z.lazy(() => GetProjectsProjectsBuilds$inboundSchema))
    .optional(),
  connectBuildsEnabled: z.boolean().optional(),
  connectConfigurationId: z.string().optional(),
  createdAt: z.number(),
  ...
  withCache: z.boolean().optional(),
  checksConclusion:
    GetProjectsProjectsChecksConclusion$inboundSchema.optional(),
...
> = z.object({
  ...
  aliasAssigned: z.nullable(z.union([z.number(), z.boolean()])).optional(),
  aliasError: z
    .nullable(z.lazy(() => GetProjectsProjectsAliasError$outboundSchema))
    .optional(),
  aliasFinal: z.nullable(z.string()).optional(),
  automaticAliases: z.array(z.string()).optional(),
  builds: z
    .array(z.lazy(() => GetProjectsProjectsBuilds$outboundSchema))
    .optional(),
  connectBuildsEnabled: z.boolean().optional(),
  connectConfigurationId: z.string().optional(),
  createdAt: z.number(),
  ...
  withCache: z.boolean().optional(),
  checksConclusion:
    GetProjectsProjectsChecksConclusion$outboundSchema.optional(),
...
> = z.object({
  ...
  value: z
    .union([z.lazy(() => GetProjectsValue2$inboundSchema), z.string()])
    .optional(),
});
...
> = z.object({
  src: z
    .union([z.lazy(() => GetProjectsSrc2$inboundSchema), z.string()])
    .optional(),
...
> = z.object({
  src: z
    .union([z.lazy(() => GetProjectsSrc2$outboundSchema), z.string()])
    .optional(),
...
> = z.object({
  ...
  speedInsights: z
    .lazy(() => GetProjectsSpeedInsights$inboundSchema)
    .optional(),
  ...
  oidcTokenConfig: z
    .lazy(() => GetProjectsOidcTokenConfig$inboundSchema)
    .optional(),
...
> = z.object({
  ...
  speedInsights: z
    .lazy(() => GetProjectsSpeedInsights$outboundSchema)
    .optional(),
  autoExposeSystemEnvs: z.boolean().optional(),
  autoAssignCustomDomains: z.boolean().optional(),
  autoAssignCustomDomainsUpdatedBy: z.string().optional(),
  ...
  oidcTokenConfig: z
    .lazy(() => GetProjectsOidcTokenConfig$outboundSchema)
    .optional(),
