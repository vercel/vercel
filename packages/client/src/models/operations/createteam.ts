...
/** @internal */
export const Utm$inboundSchema: z.ZodType<Utm, z.ZodTypeDef, unknown> =
  z.object({
...
/** @internal */
export const Utm$outboundSchema: z.ZodType<Utm$Outbound, z.ZodTypeDef, Utm> =
  z.object({
    utmSource: z.string().optional(),
    utmMedium: z.string().optional(),
    utmCampaign: z.string().optional(),
...
> = z.object({
  ...
  disabledAt: z.nullable(z.number()).optional(),
  frequency: z
    .lazy(() => CreateTeamTeamsResponseFrequency$inboundSchema)
    .optional(),
  maxQuantity: z.number().optional(),
});
...
> = z.object({
  ...
  disabledAt: z.nullable(z.number()).optional(),
  frequency: z
    .lazy(() => CreateTeamTeamsResponseFrequency$outboundSchema)
    .optional(),
  maxQuantity: z.number().optional(),
});
...
> = z.object({
  ...
  disabledAt: z.nullable(z.number()).optional(),
  frequency: z
    .lazy(() => CreateTeamTeamsResponse200Frequency$inboundSchema)
    .optional(),
  maxQuantity: z.number().optional(),
});
...
> = z.object({
  ...
  disabledAt: z.nullable(z.number()).optional(),
  frequency: z
    .lazy(() => CreateTeamTeamsResponse200Frequency$outboundSchema)
    .optional(),
  maxQuantity: z.number().optional(),
});
...
> = z.object({
  matrix: z
    .lazy(() => CreateTeamTeamsResponse200Matrix$inboundSchema)
    .optional(),
  tier: z.number().optional(),
  price: z.number(),
  batch: z.number(),
...
> = z.object({
  matrix: z
    .lazy(() => CreateTeamTeamsResponse200Matrix$outboundSchema)
    .optional(),
  tier: z.number().optional(),
  price: z.number(),
  batch: z.number(),
