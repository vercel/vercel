...
> = z.object({
  ...
  projects: z
    .array(z.lazy(() => InviteUserToTeamProjects$inboundSchema))
    .optional(),
});
...
> = z.object({
  ...
  projects: z
    .array(z.lazy(() => InviteUserToTeamProjects$outboundSchema))
    .optional(),
});
...
> = z
  .object({
    teamId: z.string(),
    RequestBody: z
      .lazy(() => InviteUserToTeamRequestBody$inboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    teamId: z.string(),
    requestBody: z
      .lazy(() => InviteUserToTeamRequestBody$outboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
