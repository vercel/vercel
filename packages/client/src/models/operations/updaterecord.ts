...
/** @internal */
export const Srv$inboundSchema: z.ZodType<Srv, z.ZodTypeDef, unknown> =
  z.object({
...
/** @internal */
export const Srv$outboundSchema: z.ZodType<Srv$Outbound, z.ZodTypeDef, Srv> =
  z.object({
    target: z.nullable(z.string()),
    weight: z.nullable(z.number().int()),
    port: z.nullable(z.number().int()),
...
/** @internal */
export const Https$inboundSchema: z.ZodType<Https, z.ZodTypeDef, unknown> =
  z.object({
    priority: z.nullable(z.number().int()),
    target: z.nullable(z.string()),
...
> = z
  .object({
    ...
    slug: z.string().optional(),
    requestBody: z
      .lazy(() => UpdateRecordRequestBody$outboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
