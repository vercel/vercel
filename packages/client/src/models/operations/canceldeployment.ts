...
> = z.object({
  ...
  speedInsights: z
    .lazy(() => CancelDeploymentSpeedInsights$inboundSchema)
    .optional(),
  webAnalytics: z
    .lazy(() => CancelDeploymentWebAnalytics$inboundSchema)
    .optional(),
});
...
> = z.object({
  ...
  outputDirectory: z.nullable(z.string()).optional(),
  speedInsights: z
    .lazy(() => CancelDeploymentSpeedInsights$outboundSchema)
    .optional(),
  webAnalytics: z
    .lazy(() => CancelDeploymentWebAnalytics$outboundSchema)
    .optional(),
});
...
> = z.object({
  ...
  verified: z.boolean(),
  verification: z
    .array(z.lazy(() => CustomEnvironmentVerification$inboundSchema))
    .optional(),
});
...
> = z.object({
  ...
  verified: z.boolean(),
  verification: z
    .array(z.lazy(() => CustomEnvironmentVerification$outboundSchema))
    .optional(),
});
...
> = z.object({
  ...
  branchMatcher: z
    .lazy(() => CustomEnvironmentBranchMatcher$inboundSchema)
    .optional(),
  createdAt: z.number(),
  updatedAt: z.number(),
  domains: z
    .array(z.lazy(() => CustomEnvironmentDomains$inboundSchema))
    .optional(),
});
...
> = z.object({
  ...
  description: z.string().optional(),
  branchMatcher: z
    .lazy(() => CustomEnvironmentBranchMatcher$outboundSchema)
    .optional(),
  createdAt: z.number(),
  updatedAt: z.number(),
  domains: z
    .array(z.lazy(() => CustomEnvironmentDomains$outboundSchema))
    .optional(),
});
...
> = z.object({
  ...
  builds: z
    .array(z.lazy(() => CancelDeploymentBuilds$inboundSchema))
    .optional(),
  env: z.array(z.string()),
  ...
  lambdas: z
    .array(z.lazy(() => CancelDeploymentLambdas$inboundSchema))
    .optional(),
  public: z.boolean(),
...
> = z.object({
  ...
  buildArtifactUrls: z.array(z.string()).optional(),
  builds: z
    .array(z.lazy(() => CancelDeploymentBuilds$outboundSchema))
    .optional(),
  env: z.array(z.string()),
  inspectorUrl: z.nullable(z.string()),
  isInConcurrentBuildsQueue: z.boolean(),
  ...
  isFirstBranchDeployment: z.boolean().optional(),
  lambdas: z
    .array(z.lazy(() => CancelDeploymentLambdas$outboundSchema))
    .optional(),
  public: z.boolean(),
  ready: z.number().optional(),
