...
/** @internal */
export const Redirects$inboundSchema: z.ZodNativeEnum<typeof Redirects> =
  z.nativeEnum(Redirects);
...
/** @internal */
export const Verified$inboundSchema: z.ZodNativeEnum<typeof Verified> =
...
/** @internal */
export const Order$inboundSchema: z.ZodNativeEnum<typeof Order> =
  z.nativeEnum(Order);
...
> = z.object({
  ...
  verified: z.boolean(),
  verification: z
    .array(z.lazy(() => GetProjectDomainsVerification$inboundSchema))
    .optional(),
});
...
> = z.object({
  ...
  verified: z.boolean(),
  verification: z
    .array(z.lazy(() => GetProjectDomainsVerification$outboundSchema))
    .optional(),
});
