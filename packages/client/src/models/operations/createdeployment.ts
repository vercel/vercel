...
/** @internal */
export const ForceNew$inboundSchema: z.ZodNativeEnum<typeof ForceNew> =
  z.nativeEnum(ForceNew);
...
/** @internal */
export const Encoding$inboundSchema: z.ZodNativeEnum<typeof Encoding> =
  z.nativeEnum(Encoding);
...
/** @internal */
export const Framework$inboundSchema: z.ZodNativeEnum<typeof Framework> =
  z.nativeEnum(Framework);
...
> = z
  .object({
    ...
    skipAutoDetectionConfirmation:
      SkipAutoDetectionConfirmation$inboundSchema.optional(),
    teamId: z.string().optional(),
    slug: z.string().optional(),
    RequestBody: z
      .lazy(() => CreateDeploymentRequestBody$inboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    ...
    skipAutoDetectionConfirmation:
      SkipAutoDetectionConfirmation$outboundSchema.optional(),
    teamId: z.string().optional(),
    slug: z.string().optional(),
    requestBody: z
      .lazy(() => CreateDeploymentRequestBody$outboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
...
/** @internal */
export const Build$inboundSchema: z.ZodType<Build, z.ZodTypeDef, unknown> =
  z.object({
...
> = z.object({
  ...
  outputDirectory: z.nullable(z.string()).optional(),
  speedInsights: z
    .lazy(() => CreateDeploymentSpeedInsights$inboundSchema)
    .optional(),
  webAnalytics: z
    .lazy(() => CreateDeploymentWebAnalytics$inboundSchema)
    .optional(),
});
...
> = z.object({
  ...
  outputDirectory: z.nullable(z.string()).optional(),
  speedInsights: z
    .lazy(() => CreateDeploymentSpeedInsights$outboundSchema)
    .optional(),
  webAnalytics: z
    .lazy(() => CreateDeploymentWebAnalytics$outboundSchema)
    .optional(),
});
...
/** @internal */
export const Has2$inboundSchema: z.ZodType<Has2, z.ZodTypeDef, unknown> =
  z.object({
...
/** @internal */
export const HasType$inboundSchema: z.ZodNativeEnum<typeof HasType> =
  z.nativeEnum(HasType);
...
/** @internal */
export const Has1$inboundSchema: z.ZodType<Has1, z.ZodTypeDef, unknown> =
  z.object({
...
/** @internal */
export const Locale$inboundSchema: z.ZodType<Locale, z.ZodTypeDef, unknown> =
  z.object({
...
/** @internal */
export const Flags2$inboundSchema: z.ZodType<Flags2, z.ZodTypeDef, unknown> =
  z.object({});
...
/** @internal */
export const Flags1$inboundSchema: z.ZodType<Flags1, z.ZodTypeDef, unknown> =
  z.object({
...
> = z.object({
  ...
  builds: z
    .array(z.lazy(() => CreateDeploymentBuilds$inboundSchema))
    .optional(),
  env: z.array(z.string()),
  ...
  monorepoManager: z.nullable(z.string()).optional(),
  functions: z
    .nullable(z.record(z.lazy(() => Functions$inboundSchema)))
    .optional(),
  routes: z.nullable(
    z.array(
      z.union([
...
> = z.object({
  ...
  buildArtifactUrls: z.array(z.string()).optional(),
  builds: z
    .array(z.lazy(() => CreateDeploymentBuilds$outboundSchema))
    .optional(),
  env: z.array(z.string()),
  inspectorUrl: z.nullable(z.string()),
  isInConcurrentBuildsQueue: z.boolean(),
  ...
  errorMessage: z.nullable(z.string()).optional(),
  aliasWarning: z
    .nullable(z.lazy(() => AliasWarning$outboundSchema))
    .optional(),
  ...
  monorepoManager: z.nullable(z.string()).optional(),
  functions: z
    .nullable(z.record(z.lazy(() => Functions$outboundSchema)))
    .optional(),
  routes: z.nullable(
    z.array(
      z.union([
