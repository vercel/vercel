...
/** @internal */
export const Two4$inboundSchema: z.ZodType<Two4, z.ZodTypeDef, unknown> =
  z.object({});
...
/** @internal */
export const Items2$inboundSchema: z.ZodType<Items2, z.ZodTypeDef, unknown> =
  z.union([
...
/** @internal */
export const One4$inboundSchema: z.ZodType<One4, z.ZodTypeDef, unknown> =
  z.object({});
...
> = z
  .object({
    ...
    RequestBody: z
      .lazy(() => CreateEdgeConfigRequestBody$inboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    ...
    slug: z.string().optional(),
    requestBody: z
      .lazy(() => CreateEdgeConfigRequestBody$outboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
