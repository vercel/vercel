...
/** @internal */
export const Decrypt$inboundSchema: z.ZodNativeEnum<typeof Decrypt> =
  z.nativeEnum(Decrypt);
...
/** @internal */
export const Envs$inboundSchema: z.ZodType<Envs, z.ZodTypeDef, unknown> =
  z.object({
    target: z
      .union([
        z.array(FilterProjectEnvsTargetEnvs1$inboundSchema),
