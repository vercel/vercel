...
/** @internal */
export const Lambda$inboundSchema: z.ZodType<Lambda, z.ZodTypeDef, unknown> =
  z.object({
...
/** @internal */
export const Edge$inboundSchema: z.ZodType<Edge, z.ZodTypeDef, unknown> =
  z.object({
...
/** @internal */
export const Builds$inboundSchema: z.ZodType<Builds, z.ZodTypeDef, unknown> =
  z.object({
    id: z.string(),
    deploymentId: z.string(),
    entrypoint: z.string(),
