...
export type GetDeploymentEventsResponseBodyDeploymentsResponse200Type =
  ClosedEnum<typeof GetDeploymentEventsResponseBodyDeploymentsResponse200Type>;
...
/** @internal */
export const Direction$inboundSchema: z.ZodNativeEnum<typeof Direction> =
...
> = z.object({
  ...
  wafAction:
    GetDeploymentEventsResponseBodyDeploymentsWafAction$inboundSchema.optional(),
...
> = z.object({
  ...
  lambdaRegion: z.string().optional(),
  wafAction:
    GetDeploymentEventsResponseBodyDeploymentsWafAction$outboundSchema.optional(),
  wafRuleId: z.string().optional(),
});
...
> = z.object({
  ...
  vercelId: z.string().optional(),
  vercelCache:
    GetDeploymentEventsResponseBodyVercelCache$inboundSchema.optional(),
  lambdaRegion: z.string().optional(),
...
> = z.object({
  ...
  vercelId: z.string().optional(),
  vercelCache:
    GetDeploymentEventsResponseBodyVercelCache$outboundSchema.optional(),
  lambdaRegion: z.string().optional(),
...
export const Payload$inboundSchema: z.ZodType<Payload, z.ZodTypeDef, unknown> =
  z.object({
    deploymentId: z.string(),
    info: z
      .lazy(() => GetDeploymentEventsResponseBodyInfo$inboundSchema)
      .optional(),
    text: z.string().optional(),
    id: z.string(),
    date: z.number(),
    ...
    requestId: z.string().optional(),
    proxy: z
      .lazy(() => GetDeploymentEventsResponseBodyProxy$inboundSchema)
      .optional(),
  });
...
> = z.object({
  deploymentId: z.string(),
  info: z
    .lazy(() => GetDeploymentEventsResponseBodyInfo$outboundSchema)
    .optional(),
  text: z.string().optional(),
  id: z.string(),
  date: z.number(),
  ...
  requestId: z.string().optional(),
  proxy: z
    .lazy(() => GetDeploymentEventsResponseBodyProxy$outboundSchema)
    .optional(),
});
...
/** @internal */
export const WafAction$inboundSchema: z.ZodNativeEnum<typeof WafAction> =
  z.nativeEnum(WafAction);
...
/** @internal */
export const Proxy$inboundSchema: z.ZodType<Proxy, z.ZodTypeDef, unknown> =
  z.object({
    timestamp: z.number(),
    method: z.string(),
    host: z.string(),
