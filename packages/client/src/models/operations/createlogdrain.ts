...
/** @internal */
export const Sources$inboundSchema: z.ZodNativeEnum<typeof Sources> =
  z.nativeEnum(Sources);
...
> = z
  .object({
    ...
    RequestBody: z
      .lazy(() => CreateLogDrainRequestBody$inboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    ...
    slug: z.string().optional(),
    requestBody: z
      .lazy(() => CreateLogDrainRequestBody$outboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
