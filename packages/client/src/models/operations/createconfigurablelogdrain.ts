...
> = z.object({
  ...
  environments: z
    .array(CreateConfigurableLogDrainEnvironments$inboundSchema)
    .optional(),
...
> = z.object({
  ...
  updatedAt: z.number(),
  sources: z
    .array(CreateConfigurableLogDrainLogDrainsSources$inboundSchema)
    .optional(),
  headers: z.record(z.string()).optional(),
  ...
  disabledReason:
    CreateConfigurableLogDrainDisabledReason$inboundSchema.optional(),
...
> = z.object({
  ...
  updatedAt: z.number(),
  sources: z
    .array(CreateConfigurableLogDrainLogDrainsSources$outboundSchema)
    .optional(),
  headers: z.record(z.string()).optional(),
  environments: z.array(
    CreateConfigurableLogDrainLogDrainsEnvironments$outboundSchema
  ...
  disabledAt: z.number().optional(),
  disabledReason:
    CreateConfigurableLogDrainDisabledReason$outboundSchema.optional(),
  disabledBy: z.string().optional(),
  firstErrorTimestamp: z.number().optional(),
  samplingRate: z.number().optional(),
