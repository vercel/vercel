...
/** @internal */
export const Origin$inboundSchema: z.ZodNativeEnum<typeof Origin> =
  z.nativeEnum(Origin);
...
> = z
  .object({
    teamId: z.string(),
    RequestBody: z
      .lazy(() => RequestAccessToTeamRequestBody$inboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
...
> = z
  .object({
    teamId: z.string(),
    requestBody: z
      .lazy(() => RequestAccessToTeamRequestBody$outboundSchema)
      .optional(),
  })
  .transform(v => {
    return remap$(v, {
...
/** @internal */
export const Github$inboundSchema: z.ZodType<Github, z.ZodTypeDef, unknown> =
  z.object({
...
/** @internal */
export const Gitlab$inboundSchema: z.ZodType<Gitlab, z.ZodTypeDef, unknown> =
  z.object({
    login: z.string().optional(),
  });
...
> = z.object({
  ...
  joinedFrom: z
    .lazy(() => RequestAccessToTeamJoinedFrom$inboundSchema)
    .optional(),
...
> = z.object({
  ...
  confirmed: z.boolean().optional(),
  joinedFrom: z
    .lazy(() => RequestAccessToTeamJoinedFrom$outboundSchema)
    .optional(),
  accessRequestedAt: z.number().optional(),
