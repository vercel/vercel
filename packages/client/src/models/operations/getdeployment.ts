...
export type GetDeploymentResponseBody1 = {
  ...
  routes: Array<
    GetDeploymentRoutes3 | GetDeploymentRoutes2 | GetDeploymentRoutes1
  > | null;
  gitRepo?:
    | GetDeploymentGitRepo1
    | GetDeploymentGitRepo2
...
> = z.object({
  ...
  entrypoint: z.nullable(z.string()).optional(),
  readyState:
    GetDeploymentResponseBodyDeploymentsReadyState$outboundSchema.optional(),
  readyStateAt: z.number().optional(),
...
> = z.object({
  ...
  checksConclusion:
    GetDeploymentResponseBodyChecksConclusion$inboundSchema.optional(),
  ...
  project: z
    .lazy(() => GetDeploymentResponseBodyProject$inboundSchema)
    .optional(),
  readySubstate:
    GetDeploymentResponseBodyReadySubstate$inboundSchema.optional(),
...
> = z.object({
  ...
  checksConclusion:
    GetDeploymentResponseBodyChecksConclusion$outboundSchema.optional(),
  deletedAt: z.nullable(z.number()).optional(),
  canceledAt: z.number().optional(),
  errorCode: z.string().optional(),
  errorLink: z.string().optional(),
  ...
  meta: z.record(z.string()),
  project: z
    .lazy(() => GetDeploymentResponseBodyProject$outboundSchema)
    .optional(),
  readySubstate:
    GetDeploymentResponseBodyReadySubstate$outboundSchema.optional(),
  regions: z.array(z.string()),
  softDeletedByRetention: z.boolean().optional(),
...
export namespace GetDeploymentResponseBodyFramework$ {
  ...
  export const outboundSchema =
    GetDeploymentResponseBodyFramework$outboundSchema;
}
...
> = z.object({
  ...
  framework: z
    .nullable(GetDeploymentResponseBodyFramework$inboundSchema)
    .optional(),
  commandForIgnoringBuildStep: z.nullable(z.string()).optional(),
  installCommand: z.nullable(z.string()).optional(),
  outputDirectory: z.nullable(z.string()).optional(),
  speedInsights: z
    .lazy(() => ResponseBodySpeedInsights$inboundSchema)
    .optional(),
...
> = z.object({
  ...
  devCommand: z.nullable(z.string()).optional(),
  framework: z
    .nullable(GetDeploymentResponseBodyFramework$outboundSchema)
    .optional(),
  commandForIgnoringBuildStep: z.nullable(z.string()).optional(),
  installCommand: z.nullable(z.string()).optional(),
  outputDirectory: z.nullable(z.string()).optional(),
  speedInsights: z
    .lazy(() => ResponseBodySpeedInsights$outboundSchema)
    .optional(),
  webAnalytics: z
    .lazy(() => ResponseBodyWebAnalytics$outboundSchema)
    .optional(),
});
...
> = z.object({
  ...
  updatedAt: z.number(),
  domains: z
    .array(z.lazy(() => GetDeploymentCustomEnvironmentDomains$inboundSchema))
    .optional(),
});
...
> = z.object({
  ...
  updatedAt: z.number(),
  domains: z
    .array(z.lazy(() => GetDeploymentCustomEnvironmentDomains$outboundSchema))
    .optional(),
});
...
> = z.object({
  options: z
    .array(z.lazy(() => GetDeploymentFlagsOptions$inboundSchema))
    .optional(),
...
> = z.object({
  options: z
    .array(z.lazy(() => GetDeploymentFlagsOptions$outboundSchema))
    .optional(),
  url: z.string().optional(),
  description: z.string().optional(),
});
...
> = z.object({
  ...
  aliasError: z
    .nullable(z.lazy(() => ResponseBodyAliasError$inboundSchema))
    .optional(),
  aliasFinal: z.nullable(z.string()).optional(),
  autoAssignCustomDomains: z.boolean().optional(),
  automaticAliases: z.array(z.string()).optional(),
...
> = z.object({
  ...
  aliasError: z
    .nullable(z.lazy(() => ResponseBodyAliasError$outboundSchema))
    .optional(),
  aliasFinal: z.nullable(z.string()).optional(),
  autoAssignCustomDomains: z.boolean().optional(),
  automaticAliases: z.array(z.string()).optional(),
