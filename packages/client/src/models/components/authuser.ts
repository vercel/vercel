...
/** @internal */
export const Reason$inboundSchema: z.ZodNativeEnum<typeof Reason> =
  z.nativeEnum(Reason);
...
/** @internal */
export const Currency$inboundSchema: z.ZodNativeEnum<typeof Currency> =
...
/** @internal */
export const Plan$inboundSchema: z.ZodNativeEnum<typeof Plan> =
  z.nativeEnum(Plan);
...
/** @internal */
export const Platform$inboundSchema: z.ZodNativeEnum<typeof Platform> =
...
/** @internal */
export const Trial$inboundSchema: z.ZodType<Trial, z.ZodTypeDef, unknown> =
  z.object({
    start: z.number(),
    end: z.number(),
  });
...
/** @internal */
export const Tax$outboundSchema: z.ZodType<Tax$Outbound, z.ZodTypeDef, Tax> =
  z.object({
    type: z.string(),
    id: z.string(),
  });
...
/** @internal */
export const Pro$inboundSchema: z.ZodType<Pro, z.ZodTypeDef, unknown> =
  z.object({
    tier: z.number().optional(),
    price: z.number(),
    quantity: z.number(),
...
/** @internal */
export const Pro$outboundSchema: z.ZodType<Pro$Outbound, z.ZodTypeDef, Pro> =
  z.object({
    tier: z.number().optional(),
    price: z.number(),
    quantity: z.number(),
...
> = z.object({
  ...
  disabledAt: z.nullable(z.number()).optional(),
  frequency: z
    .lazy(() => AuthUserBillingInvoiceItemsFrequency$inboundSchema)
    .optional(),
  maxQuantity: z.number().optional(),
});
...
/** @internal */
export const Matrix$inboundSchema: z.ZodType<Matrix, z.ZodTypeDef, unknown> =
  z.object({
...
> = z.object({
  matrix: z
    .lazy(() => AuthUserBillingInvoiceItemsMatrix$inboundSchema)
    .optional(),
  tier: z.number().optional(),
  price: z.number(),
  batch: z.number(),
...
> = z.object({
  matrix: z
    .lazy(() => AuthUserBillingInvoiceItemsMatrix$outboundSchema)
    .optional(),
  tier: z.number().optional(),
  price: z.number(),
  batch: z.number(),
...
> = z.object({
  ...
  developerExperiencePlatform: z
    .lazy(() => DeveloperExperiencePlatform$inboundSchema)
    .optional(),
  includedAllocationMiu: z
    .lazy(() => IncludedAllocationMiu$inboundSchema)
    .optional(),
  ...
  dataCacheRevalidation: z
    .lazy(() => DataCacheRevalidation$inboundSchema)
    .optional(),
  ...
  postgresComputeTime: z
    .lazy(() => PostgresComputeTime$inboundSchema)
    .optional(),
  postgresDataStorage: z
    .lazy(() => PostgresDataStorage$inboundSchema)
    .optional(),
  postgresDataTransfer: z
    .lazy(() => PostgresDataTransfer$inboundSchema)
    .optional(),
  postgresDatabase: z.lazy(() => PostgresDatabase$inboundSchema).optional(),
  postgresWrittenData: z
    .lazy(() => PostgresWrittenData$inboundSchema)
    .optional(),
  ...
  wafOwaspExcessBytes: z
    .lazy(() => WafOwaspExcessBytes$inboundSchema)
    .optional(),
...
> = z.object({
  ...
  developerExperiencePlatform: z
    ...
    .optional(),
  includedAllocationMiu: z
    .lazy(() => IncludedAllocationMiu$outboundSchema)
    .optional(),
  managedInfrastructureCommitment: z
  ...
  passwordProtection: z
    .lazy(() => PasswordProtection$outboundSchema)
    .optional(),
  previewDeploymentSuffix: z
  ...
  dataCacheRevalidation: z
    .lazy(() => DataCacheRevalidation$outboundSchema)
    .optional(),
  ...
  postgresComputeTime: z
    .lazy(() => PostgresComputeTime$outboundSchema)
    .optional(),
  postgresDataStorage: z
    .lazy(() => PostgresDataStorage$outboundSchema)
    .optional(),
  postgresDataTransfer: z
    .lazy(() => PostgresDataTransfer$outboundSchema)
    .optional(),
  postgresDatabase: z.lazy(() => PostgresDatabase$outboundSchema).optional(),
  postgresWrittenData: z
    .lazy(() => PostgresWrittenData$outboundSchema)
    .optional(),
  serverlessFunctionExecution: z
  ...
  storageRedisTotalDatabases: z
    ...
    .optional(),
  wafOwaspExcessBytes: z
    .lazy(() => WafOwaspExcessBytes$outboundSchema)
    .optional(),
...
/** @internal */
export const Interval$inboundSchema: z.ZodNativeEnum<typeof Interval> =
  z.nativeEnum(Interval);
...
/** @internal */
export const Duration$inboundSchema: z.ZodNativeEnum<typeof Duration> =
  z.nativeEnum(Duration);
...
/** @internal */
export const Coupon$inboundSchema: z.ZodType<Coupon, z.ZodTypeDef, unknown> =
  z.object({
    id: z.string(),
...
export const Billing$inboundSchema: z.ZodType<Billing, z.ZodTypeDef, unknown> =
  z.object({
    ...
    invoiceItems: z
      .nullable(z.lazy(() => InvoiceItems$inboundSchema))
      .optional(),
    ...
    awsMarketplace: z
      .nullable(z.lazy(() => AwsMarketplace$inboundSchema))
      .optional(),
...
> = z.object({
  ...
  name: z.nullable(z.string()).optional(),
  invoiceItems: z
    .nullable(z.lazy(() => InvoiceItems$outboundSchema))
    .optional(),
  ...
  forceOrbMigration: z.nullable(z.boolean()).optional(),
  awsMarketplace: z
    .nullable(z.lazy(() => AwsMarketplace$outboundSchema))
    .optional(),
  reseller: z.string().optional(),
});
...
/** @internal */
export const One$outboundSchema: z.ZodType<One$Outbound, z.ZodTypeDef, One> =
  z.object({
    projectId: z.string(),
    scopeSlug: z.string(),
    scopeId: z.string(),
...
/** @internal */
export const Version$inboundSchema: z.ZodNativeEnum<typeof Version> =
  z.nativeEnum(Version);
...
> = z.object({
  ...
  activeDashboardViews: z
    ...
    .optional(),
  importFlowGitNamespace: z
    .nullable(z.union([z.string(), z.number()]))
    .optional(),
  importFlowGitNamespaceId: z
    .nullable(z.union([z.string(), z.number()]))
    .optional(),
  ...
  preferredScopesAndGitNamespaces: z
    ...
    .optional(),
  dismissedToasts: z
    .array(z.lazy(() => DismissedToasts$inboundSchema))
    .optional(),
...
> = z.object({
  ...
  preferredScopesAndGitNamespaces: z
    ...
    .optional(),
  dismissedToasts: z
    .array(z.lazy(() => DismissedToasts$outboundSchema))
    .optional(),
  favoriteProjectsAndSpaces: z
    .array(
      z.union([
  ...
  northstarMigration: z
    .lazy(() => NorthstarMigration$outboundSchema)
    .optional(),
  id: z.string(),
  email: z.string(),
  name: z.nullable(z.string()),
