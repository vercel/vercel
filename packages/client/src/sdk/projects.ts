...
export class Projects extends ClientSDK {
  ...
  async updateDataCache(
    ...
    return unwrapAsync(projectsUpdateDataCache(this, request, options));
  }
  ...
  async pause(
    ...
    return unwrapAsync(projectsPause(this, request, options));
  }
  ...
  async unpause(
    ...
    return unwrapAsync(projectsUnpause(this, request, options));
  }
}
