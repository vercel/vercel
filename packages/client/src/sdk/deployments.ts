...
export class Deployments extends ClientSDK {
  ...
  async cancel(
    ...
    return unwrapAsync(deploymentsCancel(this, request, options));
  }
  ...
  async listAliases(
    ...
    return unwrapAsync(deploymentsListAliases(this, request, options));
  }
  ...
  async listFiles(
    ...
    return unwrapAsync(deploymentsListFiles(this, request, options));
  }
