...
export class Teams extends ClientSDK {
  ...
  async inviteUser(
    ...
    return unwrapAsync(teamsInviteUser(this, request, options));
  }
  ...
  async requestAccess(
    ...
    return unwrapAsync(teamsRequestAccess(this, request, options));
  }
  ...
  async getAccessRequest(
    ...
    return unwrapAsync(teamsGetAccessRequest(this, request, options));
  }
  ...
  async join(
    ...
    return unwrapAsync(teamsJoin(this, request, options));
  }
  ...
  async updateMember(
    ...
    return unwrapAsync(teamsUpdateMember(this, request, options));
  }
  ...
  async removeMember(
    ...
    return unwrapAsync(teamsRemoveMember(this, request, options));
  }
  ...
  async deleteInviteCode(
    ...
    return unwrapAsync(teamsDeleteInviteCode(this, request, options));
  }
}
