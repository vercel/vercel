...
export class Tokens extends ClientSDK {
  ...
  async create(
    ...
    return unwrapAsync(tokensCreate(this, request, options));
  }
  ...
  async get(
    ...
    return unwrapAsync(tokensGet(this, request, options));
  }
  ...
  async delete(
    ...
    return unwrapAsync(tokensDelete(this, request, options));
  }
}
