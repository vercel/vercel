...
export class Domains extends ClientSDK {
  ...
  async buy(
    ...
    return unwrapAsync(domainsBuy(this, request, options));
  }
  ...
  async checkPrice(
    ...
    return unwrapAsync(domainsCheckPrice(this, request, options));
  }
  ...
  async getTransfer(
    ...
    return unwrapAsync(domainsGetTransfer(this, request, options));
  }
  ...
  async getConfig(
    ...
    return unwrapAsync(domainsGetConfig(this, request, options));
  }
  ...
  async get(
    ...
    return unwrapAsync(domainsGet(this, request, options));
  }
  ...
  async createOrTransfer(
    ...
    return unwrapAsync(domainsCreateOrTransfer(this, request, options));
  }
  ...
  async verify(
    ...
    return unwrapAsync(domainsVerify(this, request, options));
  }
}
