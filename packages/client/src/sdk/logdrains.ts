...
export class LogDrains extends ClientSDK {
  ...
  async list(
    ...
    return unwrapAsync(logDrainsList(this, request, options));
  }
  ...
  async create(
    ...
    return unwrapAsync(logDrainsCreate(this, request, options));
  }
  ...
  async deleteIntegration(
    ...
    return unwrapAsync(logDrainsDeleteIntegration(this, request, options));
  }
  ...
  async getConfigurable(
    ...
    return unwrapAsync(logDrainsGetConfigurable(this, request, options));
  }
  ...
  async deleteConfigurable(
    ...
    return unwrapAsync(logDrainsDeleteConfigurable(this, request, options));
  }
  ...
  async getAll(
    ...
    return unwrapAsync(logDrainsGetAll(this, request, options));
  }
  ...
  async createConfigurable(
    ...
    return unwrapAsync(logDrainsCreateConfigurable(this, request, options));
  }
}
