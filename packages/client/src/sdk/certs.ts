...
export class Certs extends ClientSDK {
  ...
  async getById(
    ...
    return unwrapAsync(certsGetById(this, request, options));
  }
  ...
  async remove(
    ...
    return unwrapAsync(certsRemove(this, request, options));
  }
  ...
  async issue(
    ...
    return unwrapAsync(certsIssue(this, request, options));
  }
  ...
  async upload(
    ...
    return unwrapAsync(certsUpload(this, request, options));
  }
}
