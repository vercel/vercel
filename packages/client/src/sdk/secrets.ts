...
export class Secrets extends ClientSDK {
  ...
  async list(
    ...
    return unwrapAsync(secretsList(this, request, options));
  }
  ...
  async create(
    ...
    return unwrapAsync(secretsCreate(this, request, options));
  }
  ...
  async rename(
    ...
    return unwrapAsync(secretsRename(this, request, options));
  }
  ...
  async get(
    ...
    return unwrapAsync(secretsGet(this, request, options));
  }
  ...
  async delete(
    ...
    return unwrapAsync(secretsDelete(this, request, options));
  }
}
