...
export class Checks extends ClientSDK {
  ...
  async create(
    ...
    return unwrapAsync(checksCreate(this, request, options));
  }
  ...
  async list(
    ...
    return unwrapAsync(checksList(this, request, options));
  }
  ...
  async get(
    ...
    return unwrapAsync(checksGet(this, request, options));
  }
  ...
  async rerequest(
    ...
    return unwrapAsync(checksRerequest(this, request, options));
  }
}
