...
export interface SubscriberDeclaration {
   ...
   * served through a generated runtime callback handler); legacy
   * vercel-workers bootstrap serves the named object directly and requires it.
   */
  variableName?: string;
 ...
 * subscriptions through the Python runtime's queue callback adapter.
 */
