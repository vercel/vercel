...
const FUNCTIONS_BETA_HINT =
  '\n\nAlternatively, run `vercel deploy --functions-beta` to use extended ' +
  'function limits (up to 1 GB).';
    ...
    if (
      ...
      throw new NowBuildError({
        ...
        message:
          ...
          (shouldShowFunctionsBetaHint() ? FUNCTIONS_BETA_HINT : ''),
