...
# Workflow entrypoint ("flows:workflows"). The queue namespace scopes the
# workflow and step topics this registry subscribes to, so it can coexist
# with the registry in multiplication_flows.py.
