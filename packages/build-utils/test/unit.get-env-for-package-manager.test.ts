  ...
  describe('with "pnpm"', () => {
    test.each<{
      ...
      },
      {
        ...
        consoleLogOutput:
          'Detected `pnpm-lock.yaml` 9 which may be generated by pnpm@9.x or pnpm@10.x\nUsing pnpm@10.x based on project creation date. To use pnpm@9.x, manually opt in using corepack (https://vercel.com/docs/deployments/configure-a-build#corepack).',
        consoleWarnOutput: null,
      },
      {
        ...
        consoleLogOutput:
          'Detected pnpm@10.x with package.json#packageManager pnpm@9.5.0',
        consoleWarnOutput: null,
      },
      {
