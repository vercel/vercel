  ...
  describe('with "pnpm"', () => {
    test.each<{
      ...
      },
      {
        ...
        consoleLogOutput:
          'Detected `pnpm-lock.yaml` 9 which may be generated by pnpm@9.x, pnpm@10.x, or pnpm@11.x\nUsing pnpm@10.x based on project creation date\nTo use a different version, manually opt in using corepack (https://vercel.com/docs/deployments/configure-a-build#corepack)',
        consoleWarnOutput: null,
      },
      {
        name: 'should set path if pnpm 11 is detected',
        args: {
          cliType: 'pnpm',
        ...
        consoleLogOutput:
          'Detected `pnpm-lock.yaml` 9 which may be generated by pnpm@9.x, pnpm@10.x, or pnpm@11.x\nUsing pnpm@11.x based on project creation date\nTo use a different version, manually opt in using corepack (https://vercel.com/docs/deployments/configure-a-build#corepack)',
        consoleWarnOutput: null,
      },
      {
        name: 'should detect pnpm 11 with packageManager field pnpm 10',
        args: {
          cliType: 'pnpm',
          nodeVersion: getNodeVersionByMajor(22),
          packageJsonPackageManager: 'pnpm@10.5.0',
          lockfileVersion: 9.0,
          env: {
            FOO: 'bar',
            PATH: 'foo',
        ...
        consoleLogOutput:
          'Detected `pnpm-lock.yaml` version 9 generated by pnpm@11.x with package.json#packageManager pnpm@10.5.0',
        consoleWarnOutput: null,
      },
      {
