...
// Extract package name from a versioned specifier, stripping any peer dep suffix.
// Works for: foo@1.2.3, @scope/pkg@1.2.3, foo@1.2.3(react@18),
...
// Peer dep variants use '_' or '()' suffix.
...
function parsePnpmLock(
  ...
  const parseKey =
    lv >= 9 ? parsePnpmV9Key : lv >= 6 ? parsePnpmV6Key : parsePnpmV5Key;
