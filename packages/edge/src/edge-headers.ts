 ...
 */
export const COUNTRY_REGION_HEADER_NAME = 'x-vercel-ip-country-region';
/**
 ...
 * @see {@link COUNTRY_REGION_HEADER_NAME}
...
export function geolocation(request: Request): Geo {
  return {
    ...
    countryRegion: getHeader(request, COUNTRY_REGION_HEADER_NAME),
