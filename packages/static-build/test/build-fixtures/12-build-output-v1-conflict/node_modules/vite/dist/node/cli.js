...
var index = require('./chunks/dep-59dc6e00.js');
...
cli
    ...
    .option('--force', `[boolean] force the optimizer to ignore the cache and re-bundle`)
    .action(async (root, options) => {
    const { optimizeDeps } = await Promise.resolve().then(function () { return require('./chunks/dep-59dc6e00.js'); }).then(function (n) { return n.index; });
    try {
...
cli
    ...
    .option('--open [path]', `[boolean | string] open browser on startup`)
    .action(async (root, options) => {
    const { preview } = await Promise.resolve().then(function () { return require('./chunks/dep-59dc6e00.js'); }).then(function (n) { return n.preview$1; });
    try {
