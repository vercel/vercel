var drawChart = (function (exports) {
  ...
  const Tooltip = ({ node, root, sizeProperty }) => {
      ...
      const content = d(() => {
          ...
          return (e$1(d$1, { children: [e$1("div", Object.assign({ className: "details-name" }, { children: node.data.name }), void 0), e$1("div", Object.assign({ className: "details-percentage" }, { children: percentageString }), void 0), availableSizeProperties.map((sizeProp) => {
                      if (sizeProp === sizeProperty) {
                          return (e$1("div", Object.assign({ className: "details-size" }, { children: e$1("b", { children: [LABELS[sizeProp], ": ", format_1(getModuleSize(node.data, sizeProp))] }, void 0) }), void 0));
                      }
                      else {
                          return (e$1("div", Object.assign({ className: "details-size" }, { children: [LABELS[sizeProp], ": ", format_1(getModuleSize(node.data, sizeProp))] }), void 0));
                      }
                  })] }, void 0));
      }, [availableSizeProperties, getModuleSize, node, root.data, sizeProperty]);
      return e$1("div", Object.assign({ className: "details" }, { children: content }), void 0);
  };
  ...
  const Chart = ({ root, sizeProperty, selectedNode, setSelectedNode }) => {
      ...
      return (e$1(d$1, { children: [e$1(SunBurst, { root: root, onNodeHover: (node) => {
                      setTooltipNode(node);
                  }, isNodeHighlighted: isNodeHighlighted, selectedNode: selectedNode, onNodeClick: (node) => {
                      setSelectedNode(selectedNode === node ? undefined : node);
                  } }, void 0), e$1(Tooltip, { node: tooltipNode, root: root, sizeProperty: sizeProperty }, void 0)] }, void 0));
  };
