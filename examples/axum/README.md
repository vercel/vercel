...
Deploy your [Axum](https://github.com/tokio-rs/axum) project to Vercel with zero configuration.
...
To view the source code for this template, [visit the example repository](https://github.com/vercel/vercel/tree/main/examples/axum).
