...
export default async function Home() {
	...
	return (
      ...
      <FlagValues values={{
        [exampleFlag.key]: exampleFlagValue
      }} />
			<main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
					<Image
						className={exampleFlagValue ? "dark:invert opacity-50" : "dark:invert"}
						src="/next.svg"
						alt="Next.js logo"
						width={180}
						height={38}
				...
				<div className="flex gap-4 items-center flex-col sm:flex-row">
					...
					>
						<Image
							className={exampleFlagValue ? "invert dark:invert-0" : "dark:invert"}
							src="/vercel.svg"
							alt="Vercel logomark"
							width={20}
							height={20}
