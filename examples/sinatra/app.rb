...
get '/' do
  ...
  <<~HTML
    ...
    <body>
        <header>
            <nav>
                <a href="/" class="logo">Vercel + Sinatra</a>
                <div class="nav-links">
        ...
        <main>
            <div class="hero">
                <h1>Vercel + Sinatra</h1>
                <div class="hero-code">
                    <pre><code><span class="keyword">require</span> <span class="string">'sinatra'</span>

<span class="function">get</span> <span class="string">'/'</span> <span class="keyword">do</span>
  <span class="string">"Hello from Sinatra on Vercel!"</span>
<span class="keyword">end</span>

<span class="function">get</span> <span class="string">'/api/data'</span> <span class="keyword">do</span>
  <span class="class">JSON</span>.generate({ <span class="symbol">ruby:</span> <span class="string">"on Vercel"</span> })
