    ...
    <body>
        ...
        <main>
            <div class="hero">
                <h1>Vercel + Django</h1>
                <div class="hero-code">
                    <pre><code><span class="keyword">from</span> <span class="module">django.http</span> <span class="keyword">import</span> <span class="class">JsonResponse</span>

<span class="keyword">def</span> <span class="function">home</span>(<span class="variable">request</span>):
    <span class="keyword">return</span> <span class="class">JsonResponse</span>({<span class="string">"Python"</span>: <span class="string">"on Vercel"</span>})</code></pre>
                </div>
            </div>
            ...
            <div class="cards">
                <div class="card">
                    <h3>Sample Data</h3>
                    <p>Access sample JSON data through our REST-style API. Perfect for testing and development purposes.</p>
                    <a href="/api/data">Get Data →</a>
                </div>
                <div class="card">
                    <h3>Admin Panel</h3>
                    <p>Manage your data and models with Django's powerful built-in admin interface.</p>
