...
module.exports = DNS_VERIFICATION_ERROR = `Please make sure that your nameservers point to ${chalk.underline('zeit.world')}.
...
module.exports =  DOMAIN_VERIFICATION_ERROR = DNS_VERIFICATION_ERROR +
