...
//
// NOTE: CI should never reach here because test.yml installs Go for every
// affected test lane before Turbo builds this package or one of its dependents.
...
async function downloadGo() {
  ...
  // should have Go preinstalled via actions/setup-go (see test.yml). This is
  // scoped to GITHUB_ACTIONS specifically
