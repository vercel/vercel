...
/** A builder's `diagnostics()` output: a map of filename → File instance. */
export type BuilderDiagnostics = Files;
...
export interface BuildRunnerContext {
   ...
   */
  serviceName?: string;
  /** Environment to run this build with that a subprocess fork builds will use. */
