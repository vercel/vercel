...
2. **Check your scope and plan** — `vercel whoami` shows the current scope and effective plan. `vercel teams switch` changes team scope. Linking on the wrong team is a common mistake.
