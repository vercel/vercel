...
type _HookCallback = Callable[[], Awaitable[object]]
        ...
        with _hooks_lock:
            ...
            if succeeded:
                ...
                if hook.min_interval_seconds is None:
                    ...
                    hook.next_run_at = monotonic() + hook.min_interval_seconds
            else:
                hook.failures += 1
...
def _reset_invocation_hooks() -> None:
